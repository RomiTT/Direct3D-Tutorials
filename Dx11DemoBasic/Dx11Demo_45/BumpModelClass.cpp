...
bool BumpModelClass::Initialize(ID3D11Device* device, const char* modelFilename, const WCHAR* textureFilename1, const WCHAR* textureFilename2)
{
	bool result;
...
bool BumpModelClass::LoadTextures(ID3D11Device* device, const WCHAR* filename1, const WCHAR* filename2)
{
	bool result;
...
bool BumpModelClass::LoadModel(const char* filename)
{
	ifstream fin;
	char input;
	int i;
