...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	// 모델 객체 초기화
	if (!m_Model->Initialize(m_Direct3D->GetDevice(), "../Dx11Demo_19/data/square.txt",	L"../Dx11Demo_19/data/stone01.dds",
													L"../Dx11Demo_19/data/dirt01.dds", L"../Dx11Demo_19/data/alpha01.dds"))
	{
