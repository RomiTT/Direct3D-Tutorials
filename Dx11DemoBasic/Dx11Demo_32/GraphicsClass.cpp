...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	// 모델 객체 초기화
	if (!m_Model->Initialize(m_Direct3D->GetDevice(), "../Dx11Demo_32/data/cube.txt", L"../Dx11Demo_32/data/seafloor.dds", L"../Dx11Demo_32/data/bump03.dds"))
	{
...
#define GLASS	true	// t유리, f얼음
	...
	// 창 모델 객체를 초기화합니다.	
#if GLASS
	if(!m_WindowModel->Initialize(m_Direct3D->GetDevice(), "../Dx11Demo_32/data/square.txt", L"../Dx11Demo_32/data/glass01.dds", L"../Dx11Demo_32/data/bump03.dds"))	// 유리
#else
	if (!m_WindowModel->Initialize(m_Direct3D->GetDevice(), "../Dx11Demo_32/data/square.txt", L"../Dx11Demo_32/data/ice01.dds", L"../Dx11Demo_32/data/icebump01.dds"))	// 얼음
#endif
	{
